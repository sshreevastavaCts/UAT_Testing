...
export default class UserAttemptResult extends LightningElement {
    ...
    handleNext() {
        ...
        console.log('current Responses:', JSON.stringify(this.responses));
    ...
    handleBack() { 
        console.log('Back button clicked. Current Index:', this.currentIndex);
        console.log('Previous Index:', this.previousIndex);
        if (this.currentIndex > 0) {
            this.currentIndex = this.currentIndex == this.previousIndex ? this.previousIndex - 1 : this.previousIndex;
                      
            this.displayQuiz();
            // Restore selected answer for the previous question if available
            const prevResponse = this.responses[this.currentIndex];
            this.selectedAnswer = prevResponse && prevResponse.selectedAnswer ? prevResponse.selectedAnswer : '';
            console.log('Back to question index:', this.currentIndex, 'Selected Answer:', this.selectedAnswer);
            this.nextBtnIsDisabled = !this.selectedAnswer;
