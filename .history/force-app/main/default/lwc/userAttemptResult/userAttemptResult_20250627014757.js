...
export default class UserAttemptResult extends LightningElement {
    ...
    saveResponse() {       
        ...
        const response = {
            ...
            Quiz_Question_Number__c: currentQ.Id,
            Attended_By__c: this.userId,
            IsCorrect_Answer__c: (this.selectedAnswer === currentQ.Correct_Answer__c)
        };
        const allResponsesCopy = { ...responses };
        //this.responses.push(response);
        console.log('Response saved:', JSON.stringify(allResponsesCopy));
        this.selectedAnswer = ''; // Reset selected answer for next question
    }

    saveResultsToApex() {
        // Call Apex method to save results
        // This is a placeholder; implement the actual Apex call as needed
        console.log('Saving results to Apex:', JSON.stringify(this.responses));
        // Example: saveResults({ responses: this.responses });
    }
