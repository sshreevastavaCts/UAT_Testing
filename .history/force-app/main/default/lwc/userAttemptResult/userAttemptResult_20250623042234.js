...
export default class UserAttemptResult extends LightningElement {
    ...
    restorePreviousAnswer() {
        const questionId = this.question?.Id;
        console.log('Restoring answer for questionId:', questionId);
        const found = this.responses.find(r => r.questionId === questionId);
        console.log('Found response:', found);
        this.selectedAnswer = found ? found.selectedAnswer : '';
        console.log('Restored selectedAnswer:', this.selectedAnswer);
    }
