...
export default class UserAttemptResult extends LightningElement {
    ...
    saveResultsToApex() {
        ...
        this.QR_responses[this.currentIndex] = {
            Exam_Date_Time__c: this.dateTime,
            Exam_Name__c: this.testName,
            Exam_Status__c: 'Completed',
            Exam_Taken_Time__c: this.userTakenTime,
            Percentage__c: 0, // Placeholder, calculate percentage later
            Score__c: 0, // Placeholder, calculate score later
        ...
        saveResults({ quizAnswers: this.responses })
            .then(() => {
